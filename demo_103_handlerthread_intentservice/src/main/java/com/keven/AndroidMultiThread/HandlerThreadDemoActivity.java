package com.keven.AndroidMultiThread;
...
//    private String downloadUrl = "http://www.riceeater.info/uploads/PureWeather_v6.0.7.apk";
    private String downloadUrl = "https://www.wandoujia.com/apps/com.zenmen.palmchat/download/dot?ch=detail_normal_dl";
    ...
    public void install(String filePath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(
                    this
                    , "com.keven.demo_103_handlerthread_intentservice.fileprovider"
                    , apkFile);
